    ...
    <div className="slider-container mt-4 bg-white">
      <Slider {...settings} className="">
        {items.map((item, index) => (
          <div
            key={index}
            className="gap-4 bg-white border-[#D9D9D9] border-[1px]
          ...
          >
            ...
            >
              ...
              />
              <div
                className="bg-secondaryColor px-2  text-white text-sm absolute top-4 left-4
            ...
            <div className="xl:px-6 lg:px-4 sm:px-2 px-4 pt-1 h-28">
              ...
              <div className="flex items-center xl:text-base lg:text-sm sm:text-sm text-base my-3">
                {item.hours && (
                  <div className="flex gap-1 h-[14px] items-center border-r-[1px] border-black pr-2">
                    <Image src={Time} alt="Time"></Image> {item.hours} hrs
                  </div>
                )}
                {item.driveType && (
                  <div className="pl-2 flex gap-1 h-[14px] items-center border-r-[1px] border-black pr-2">
                    <Image src={Wheel} alt="Wheel"></Image> {item.driveType}
                  </div>
                )}
                {item.enginePower && (
                  <div className="pl-2 flex gap-1 h-[14px] items-center pr-2">
            ...
            <div className="border-t-[1px] border-[#D9D9D9] relative bottom-0">
              <div className="m-[1px] xl:px-6 px-4 pt-4 pb-2 bg-secondaryColor cursor-pointer">
                <span
                  className="flex items-center gap-1 font-semibold text-white mr-2 mb-2 text-base justify-center"

...
export default function HomePage({ locale, Inventorydata }) {
  ...
  const { data, error, networkStatus } = useQuery(HOMEPAGE_QUERIES, {
  ...
  const latestNewsData =
    data?.latestnews?.edges?.map((edge) => edge.node) || [];
  ...
  const countJabalpur = Inventorydata.filter(
    (item) => item.district === "Jabalpur"
  ).length;
  ...
  const handleShareClick = () => {
    ...
    const message = encodeURIComponent(
      MessageText + " https://tractor-world-2024.vercel.app/"
    );
  ...
  const exploreimages = [
    ...
    {
      image:
        language == "HI" ? CompareHi : language == "MR" ? CompareMr : Compare,
  ...
  const bannerGalleryitems = homeBannerSlides.map((src, index) => (
    <div
      key={index}
      className="relative sm:w-[1921] sm:h-[629] w-[750] h-[387] overflow-hidden"
    >
      <Image
        width={isMobile ? 750 : 1921}
        height={isMobile ? 387 : 629}
        className="w-full h-full"
        src={isMobile ? src.mobileUrl : src.desktopUrl}
        layout="responsive"
        alt={`Banner${index + 1}`}
      />
    </div>
    ...
    <div key={index} className="relative">
      <div className="">
        <Image
          ...
          className="w-full h-full"
          src={
            isMobile ? image.testimonialMobileUrl : image.testimonialDesktopUrl
          }
          layout="responsive"
      ...
      <p
        className="z-40 absolute sm:top-14 top-6 sm:text-base text-sm sm:left-14 left-3
      ...
      {image.testimonialVideoUrl && (
        <Link href={image.testimonialVideoUrl}>
          <div
            className="z-40 cursor-pointer absolute sm:bottom-8 bottom-4 sm:left-14 left-3
                   bg-primaryColor sm:px-3 sm:py-2 py-1 px-2 font-semibold text-white sm:text-base text-[14px]"
          >
            {t("Home.Watch_Video")}
          </div>
        </Link>
  ...
  return (
    <>
      ...
      <div className="relative">
        <MultipleItemsSlide
          settings={contentGallerysettings}
          id={"bannerGallery"}
          items={bannerGalleryitems}
        />

        <div
          className=" sm:flex hidden fixed z-[99] top-1/2 right-0 transform -translate-y-1/2  flex-col items-center justify-center rounded-md shadow-sm"
          role="group"
        >
          <button
            type="button"
            className="p-3 w-[50px] bg-white border-t-[1px] border-l-[1px] border-primaryColor"
          >
          ...
          <button
            type="button"
            className="p-3 w-[50px] bg-white border-t-[1px] border-l-[1px] border-b-[1px] border-primaryColor"
        ...
        <div className="sm:hidden block">
          ...
          >
            <div className="flex text-[15px]">
              ...
              <div
                className="text-center border-r border-[#FFFFFF] border-opacity-25 px-4 py-3 w-1/4"
                onClick={isShowCallModal}
              >
              ...
              <div className="text-center border-r border-[#FFFFFF] border-opacity-25 px-4 py-3 w-1/4">
                ...
                <p>
                  {" "}
                  <Link href="/enquiry">{t("Home.Enquiry")}</Link>
                </p>
              </div>

              <div
                className="text-center px-4 py-3 w-1/4"
                onClick={handleShareClick}
              >
      ...
      <div className="lg:px-14 md:px-6 sm:px-3 px-2 sm:pt-4 pt-4 sm:pb-8 py-2 bg-white ">
        <Heading
          heading={t("Home.Live_Inventory")}
          viewButton={true}
          onClick={handleAllLiveInventory}
          className="mt-8"
        />
      ...
      <div className="lg:px-14 md:px-6 sm:px-3 px-2 sm:py-4 py-2 relative bg-white mt-3">
        ...
        <div className="sm:mt-10 mt-2">
          <div
            className="grid md:grid-cols-4 grid-cols-2 md:gap-6 gap-4 w-full relative
                     z-10 sm:pb-0 pb-16"
          >
            {WhyChooseItems.map((item, index) => (
              <div key={index}>
                ...
                >
                  ...
                  <p
                    className="text-center font-bold xl:text-xl lg:text-lg 
      ...
      <div id="testimonials">
        ...
        <div className="mb-4">
          <MultipleItemsSlide
            settings={contentGallerysettings}
            id={"testimonialsGallery"}
            items={testimonialsGalleryItems}
          />
        </div>
      </div>
      ...
      {/*Content Gallery */}
      <div
        className="lg:px-14 md:px-6 sm:px-3 px-2 sm:py-4 py-2"
        style={{
      ...
      >
        <Heading
          heading={t("Home.Content_Gallery")}
          viewButton={true}
          onClick={handleContentGallery}
        />
        ...
        <div className="">
          <div className="grid sm:grid-cols-3 grid-cols-1 md:gap-6 gap-4 mt-4">
            {contentGalley.map((card, index) => (
              <div
                key={index}
                className="bg-white overflow-hidden shadow-lg flex-none"
              >
                <div className="relative">
                  <Image
                    className="w-full"
      ...
      <div className="lg:px-14 md:px-6 sm:px-3 px-2 sm:py-4 py-2">
        <Heading
          heading={t("Home.Latest_News_And_Update")}
          viewButton={true}
          onClick={handleAllContentHub}
        />
            ...
            {latestNewsGalley.map((newsData, index) => (
              ...
              >
                <div className="relative">
                  <Image
                    className="w-full"
                    src={newsData.contentGalleyUrl}
                    alt={`cardImage-${index + 1}`}
                    layout="responsive"
                    width={100}
                    height={70}
                  />
                ...
                <div className="xl:px-6 lg:px-4 sm:px-2 px-4 py-4 sm:h-52">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: newsData.contentGalleyDescription,
                    }}
                  ></p>
                </div>
                <ReadMore />
          ...
          <>
            ...
            <div className="rounded-tl-[20px] rounded-tr-[20px] bg-white py-10 px-4 flex flex-col items-center sm:flex-row sm:items-start">
              <div className="flex flex-col gap-4 w-full font-bold">
                <div className="bg-secondaryColor w-full text-white p-2 text-center rounded">
                  <Link href="tel:18006669999">{t("Home.Call_Now")}</Link>
                </div>
                <div
                  className="bg-primaryColor w-full text-white p-2 text-center rounded"
      ...
      <Modal
        showModal={showCallRequestModal}
        customStyles={requestCustomStyles}
        handleClose={handleClose}
        content={
            ...
            <div className="w-full px-4 pb-4">
              <div className="mb-2">
                ...
                <input
                  ...
                  className="w-full rounded border-[#d1cccc]"
                />
              </div>
              <div className="mb-2">
                ...
                <input
                  type="text"
                  placeholder={t("Laon.Enter_Mobile_NO")}
                  className="w-full rounded border-[#d1cccc]"
                />
              </div>

  ...
  return (
    <div>
      <Layout currentPage={"compare"}>
            ...
            <div className="sm:w-[15%] w-full">
              ...
              >
                <a
                  onClick={(e) => {
                    const isValid =
                      selectedTractorDetails[0]?.tractor_id &&
                      selectedTractorDetails[1]?.tractor_id;
                    if (!isValid) {
                      e.preventDefault();
                    }
                  }}
              ...
              <div className="px-4 py-4 w-full">
                ...
                <div className="relative w-full mt-4">
                  <input
                    ...
                    className="w-full rounded border-[1px] border-[#D0D0D0] py-2 pr-14"
                ...
                {filteredBrands.length === 0 ? (
                  <p className="mt-2 text-center text-primaryColor">
                    {t("Compare.No_Data")}
                  </p>
                ) : (
                    ...
                    {filteredBrands.map((option, index) => (
                      <div key={option.brandName}>
                        <input
                          ...
                          name="brands"
                          className="brands"
                          checked={option.brandName == selectedBrand}
        ...
        <Modal
          showModal={showBrandsModelsModal}
          customStyles={customStyles}
          handleClose={handleClose}
          content={
            <div className="flex sm:flex-row flex-col-reverse w-full">
